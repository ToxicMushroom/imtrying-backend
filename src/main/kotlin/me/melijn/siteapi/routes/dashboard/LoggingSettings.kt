...
suspend fun PipelineContext<Unit, ApplicationCall>.handleGetLoggingSettings(context: RequestContext) {
...
suspend fun PipelineContext<Unit, ApplicationCall>.handleSetLoggingSettings(context: RequestContext) {
    val postBody = getPostBodyNMessage(call) ?: return
